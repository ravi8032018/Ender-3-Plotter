...
//my changes
#define STRING_CONFIG_H_AUTHOR "(you, Ender3 Plotter)"
#define CUSTOM_MACHINE_NAME "Ravi's Ender3 Plotter"
...
//
// - Allow Z homing only after X and Y homing AND stepper drivers still enabled.s
